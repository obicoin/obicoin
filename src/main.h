...
static const int64 MAX_MONEY = 42 * 1000 * 1000 * COIN; // maximum number of coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 576 / 250; // 5760 blocks found a day. Priority cutoff is 1 OBI day / 250 bytes.
    }
