...
const string strMessageMagic = "obicoin Signed Message:\n";
...
static const int64 nTargetTimespan = 6 * 60 * 60; // obicoin: 6 hours
static const int64 nTargetSpacing = 10 * 60; // obicoin: 10 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal obicoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "obicoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xf64b5caea7be6936ce85616a8d4add89fd3e4c339286a3afdaeba479cc682e3d");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "05.01.14 00:00 GMT+1";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1389049200; // 07.01.14 00:00 GMT+1
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1345972;

        if (fTestNet)
        {
            block.nTime    = 1388876400; // 05.01.14 00:00 GMT+1
            block.nNonce   = 887627;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x85b3eb1a79a10666cde8566f91a2a0fa12354f8d8a1cdaa2d29ffb39efbf4188"));
